...
function News() {
  ...
  return (
    ...
    /> */}
      {/* {karena dalam Komponen Card identik dengan news artinya sama persis properti yang di pakai jadi kita bisa menggunakan spread operator untuk mendapatkan value arraynya} */}
      {/* <Card {...someNews[0]} />
    <Card {...someNews[1]} />
    <Card {...someNews[2]} /> */}
      {someNews.map((news) => (
